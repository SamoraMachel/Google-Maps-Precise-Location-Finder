...
public class LocationFinder<locationManager> extends Service implements LocationListener {
    Context context;boolean isGPSEnabled = false;// flag for network status
    ...
    protected LocationManager locationManager;public LocationFinder(Context context) {
